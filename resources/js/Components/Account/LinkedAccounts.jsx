...
function AccountRow({ authenticator, data, synced, onSyncChanged }) {
    ...
    return (
        <div className="flex items-center justify-between gap-4 rounded-2xl bg-background/60 px-4 py-3 shadow-clay-inset" style={{ border: '1px solid rgb(255 255 255 / 0.06)' }}>
